...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description=(
            "Export an dlshogi_static_eval_model_package_v1 bundle from the eval-only "
    ...
    p.add_argument("--package-id-prefix", default="dlshogi2-eval")
...
def main() -> None:
    ...
    artifacts = export_model_package(
    ...
    print(f"wrote model package to {artifacts.package_dir}")
